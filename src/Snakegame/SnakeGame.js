...
const SnakeGame = () => {
  ...
  const generateNewFruit = useCallback(() => {
    let newFruit;
    const checkCollision = (segment) => segment.row === newFruit.row && segment.col === newFruit.col;
    ...
    } while (snake.some(checkCollision));
  ...
  }, [snake, fruit, direction, isGameOver, score, generateNewFruit]);
